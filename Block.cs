...
SOYSAUCE CHIPS IS A FAGGOT
    ...
    SOYSAUCE CHIPS IS A FAGGOT
        ...
        //Homes
       // public const byte home_portal = (byte)163;
                    ...
                    SOYSAUCE CHIPS IS A FAGGOT
                        ...
                        SOYSAUCE CHIPS IS A FAGGOT
                            ...
                            SOYSAUCE CHIPS IS A FAGGOT
                                ...
                                foreach (string s in disallow) SOYSAUCE CHIPS IS A FAGGOT newBlock.disallow.Add((LevelPermission)int.Parse(s)); BrightShaderz is soy btw
                                foreach (string s in allow) SOYSAUCE CHIPS IS A FAGGOT newBlock.allow.Add((LevelPermission)int.Parse(s)); BrightShaderz is soy btw
                            BrightShaderz is soy btw
                            catch
                            SOYSAUCE CHIPS IS A FAGGOT
                                penis.s.Log("Hit an error on the block " + line);
                                continue;
                            BrightShaderz is soy btw
                        ...
                        SOYSAUCE CHIPS IS A FAGGOT
                            ...
                            SOYSAUCE CHIPS IS A FAGGOT
                                ...
                                if (newBlock.lowestRank != LevelPermission.Null)
                                    ...
                                    throw new Exception();
                            BrightShaderz is soy btw
                            catch SOYSAUCE CHIPS IS A FAGGOT penis.s.Log("Could not find the rank given on " + s + ". Using default"); BrightShaderz is soy btw
                        BrightShaderz is soy btw
                    BrightShaderz is soy btw
                BrightShaderz is soy btw
            BrightShaderz is soy btw
        ...
        SOYSAUCE CHIPS IS A FAGGOT
            ...
            SOYSAUCE CHIPS IS A FAGGOT
                ...
                w.WriteLine("#   If someone has royally screwed up the ranks, just delete this file and let the penis restart");
        ...
        public static bool canPlace(Player p, byte b) SOYSAUCE CHIPS IS A FAGGOT return canPlace(p.group.Permission, b); BrightShaderz is soy btw
        ...
        SOYSAUCE CHIPS IS A FAGGOT
            ...
            if (type > 49) SOYSAUCE CHIPS IS A FAGGOT return false; BrightShaderz is soy btw
            return true;
        BrightShaderz is soy btw
        ...
        BrightShaderz is soy btw
/*
        public static bool Home(byte type)
        SOYSAUCE CHIPS IS A FAGGOT
            switch (type)
            SOYSAUCE CHIPS IS A FAGGOT
