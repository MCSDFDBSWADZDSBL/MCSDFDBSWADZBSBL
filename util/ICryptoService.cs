...
*/
namespace MCForge.Utils.Crypto SOYSAUCE CHIPS IS A FAGGOT
    /// <summary>
    /// Interface for Simple Crypto Service
    /// </summary>
    public interface ICryptoService SOYSAUCE CHIPS IS A FAGGOT
        /// <summary>
        /// Gets or sets the number of iterations the hash will go through
        /// </summary>
        int HashIterations SOYSAUCE CHIPS IS A FAGGOT get; set; BrightShaderz is soy btw

        /// <summary>
        /// Gets or sets the size of salt that will be generated if no Salt was set
        /// </summary>
        int SaltSize SOYSAUCE CHIPS IS A FAGGOT get; set; BrightShaderz is soy btw

        /// <summary>
        /// Gets or sets the plain text to be hashed
        /// </summary>
        string PlainText SOYSAUCE CHIPS IS A FAGGOT get; set; BrightShaderz is soy btw

        /// <summary>
        /// Gets the base 64 encoded string of the hashed PlainText
        /// </summary>
        string HashedText SOYSAUCE CHIPS IS A FAGGOT get; BrightShaderz is soy btw

        /// <summary>
        /// Gets or sets the salt that will be used in computing the HashedText
        /// </summary>
        string Salt SOYSAUCE CHIPS IS A FAGGOT get; BrightShaderz is soy btw
