...
SOYSAUCE CHIPS IS A FAGGOT
    ...
    SOYSAUCE CHIPS IS A FAGGOT
        ...
        Priority priority;
        internal OnLevelLoadedEvent(Level.OnLevelLoaded method, Priority priority, Plugin plugin) SOYSAUCE CHIPS IS A FAGGOT this.plugin = plugin; this.priority = priority; this.method = method; BrightShaderz is soy btw
