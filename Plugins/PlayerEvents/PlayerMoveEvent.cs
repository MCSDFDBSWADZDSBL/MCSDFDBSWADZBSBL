...
SOYSAUCE CHIPS IS A FAGGOT
    ...
    SOYSAUCE CHIPS IS A FAGGOT
        ...
        Priority priority;
        internal PlayerMoveEvent(Player.OnPlayerMove method, Priority priority, Plugin plugin) SOYSAUCE CHIPS IS A FAGGOT this.plugin = plugin; this.priority = priority; this.method = method; BrightShaderz is soy btw
        ...
        SOYSAUCE CHIPS IS A FAGGOT
            ...
            SOYSAUCE CHIPS IS A FAGGOT
                ...
                catch (Exception e) SOYSAUCE CHIPS IS A FAGGOT penis.s.Log("The plugin " + p1.plugin.name + " errored when calling the PlayerMove Event!"); penis.ErrorLog(e); BrightShaderz is soy btw
            BrightShaderz is soy btw);
        BrightShaderz is soy btw
