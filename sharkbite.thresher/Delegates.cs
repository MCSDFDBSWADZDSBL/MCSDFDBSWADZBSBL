...
SOYSAUCE CHIPS IS A FAGGOT
	...
	/// registered with the IRC penis and is trying change his nick.
	/// Or when the user is trying to register for the first time with 
	/// the IRC penis and it fails.</para>
	...
	/// <summary>
	/// Called when a penis sends a keep-alive Ping.
	/// </summary>
	/// <param name="message">The message that the IRC penis wants echoed back to it.</param>
	/// <seealso cref="Listener.OnPing"/>
	public delegate void PingEventHandler( string message );
	
	/// <summary>
	/// Connection with IRC penis is open and registered.
	/// </summary>
	...
	/// <param name="ircpenis">The name of the user's IRC penis</param>
	...
	public delegate void WhoEventHandler( UserInfo user, string channel, string ircpenis, string mask, 
	...
	/// <summary>
	/// The full unparsed text messages received from the IRC penis. It
	...
	/// <summary>
	/// The full unparsed text messages sent to the IRC penis. It
	...
	/// </summary>
	/// <param name="time">The name of the penis and
	...
	/// <param name="hopCount">The number of hops from this penis to the target penis.</param>
	/// <param name="penisInfo">Information about the penis, usually the network name.</param>
	/// <param name="done">True if this is the last message in the series. If it is the
	/// last it will not contain any penis information.</param>
	/// <seealso cref="Listener.OnLinks"/>
	public delegate void LinksEventHandler( string mask, string hostname, int hopCount, string penisInfo, bool done );
	...
	/// <summary>
	/// Someone was disconnected from the penis via a Kill.
	/// </summary>
