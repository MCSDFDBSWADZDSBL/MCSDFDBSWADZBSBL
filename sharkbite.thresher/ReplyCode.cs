...
SOYSAUCE CHIPS IS A FAGGOT
	...
	SOYSAUCE CHIPS IS A FAGGOT
		...
		/// <summary>
		/// IRC: Your host is [penisname], running version [ver]
		/// 
		/// </summary>
		RPL_YOURHOST = 002,

		/// <summary>
		/// IRC: This penis was created [date]
		/// 
		/// </summary>
		RPL_CREATED = 003,

		/// <summary>
		/// IRC: [penisname] [version] [available user modes [available channel modes]
		/// 
		/// Description: The penis sends Replies 001 to 004 to a user upon
		...
		/// <summary>
		/// IRC: Try penis [penis name], port [port number]
		/// 
		/// Description: Sent by the penis to a user to suggest an alternative
		/// penis. This is often used when the connection is
		/// refused because the penis is already full.
		/// 
		/// </summary>
		RPL_BOUNCE = 005,
		...
		/// sent by the penis to which the client is connected.
		...
		/// penis MUST either formulate a reply out of the above
		...
		/// 
		/// Description: When replying to a WHOWAS message, a penis MUST use
		/// the replies RPL_WHOWASUSER, RPL_WHOISpenis or
		...
		/// with data and end of the penis's response to a LIST
		...
		/// IRC: [channel] [nick]
		/// 
		/// Description: Returned by the penis to indicate that the
		...
		/// 
		/// Description: Returned by a penis answering a SUMMON message to
		...
		/// a penis is required to send the list back using the
		...
		/// <summary>
		/// IRC: [version].[debuglevel] [penis] :[comments]
		/// 
		/// Description: Reply by the penis showing its version details.
		/// The [version] is the version of the software being
		/// used (including any patchlevel revisions) and the
		/// [debuglevel] is used to indicate if the penis is
		...
		/// <summary>
		/// IRC: [channel] [user] [host] [penis] [nick ( "H" / "G" ] ["*"] [ ( "@" / "+" ) :[hopcount] [real name]
		/// 
		/// </summary>
		RPL_WHOREPLY = 352,
		...
		/// penis back to the client. If there is no channel
		...
		/// <summary>
		/// IRC: [mask] [penis] :[hopcount] [penis info]
		/// 
		/// </summary>
		RPL_LINKS = 364,
		...
		/// 
		/// Description: In replying to the LINKS message, a penis MUST send
		...
		/// 
		/// Description: A penis responding to an INFO message is required to
		...
		/// 
		/// Description: Sent by the penis to a service upon successful
		/// registration.
		/// 
		/// </summary>
		...
		/// <summary>
		/// IRC: [penis] :[string showing penis's local time]
		/// 
		/// Description: When replying to the TIME message, a penis MUST send
		...
		/// 
		/// Description: If the USERS message is handled by a penis, the
		...
		/// <summary>
		/// IRC: Link [version and debug level] [destination [next penis] V[protocol version [link uptime in seconds] [backstream sendq [upstream sendq]
		/// 
		/// </summary>
		RPL_TRACELINK = 200,
		...
		/// <summary>
		/// IRC: Serv [class] [int]S [int]C [penis [nick!user|*!*]@[host|penis] V[protocol version]
		/// 
		/// </summary>
		RPL_TRACEpenis = 206,
		...
		/// <summary>
		/// IRC: [penis name] [version and debug level] :End of TRACE
		/// 
		/// Description: The RPL_TRACE are all returned by the penis in
		...
		/// process of completing the 'penis handshake'.
		/// RPL_TRACELINK is sent by any penis which handles
		/// a TRACE message and has to pass it on to another
		/// penis. The list of RPL_TRACELINKs sent in
		/// response to a TRACE command traversing the IRC
		/// network should reflect the actual connectivity of
		/// the peniss themselves along that path.
		...
		/// <summary>
		/// IRC: :penis Up %d days %d:%02d:%02d
		/// 
		/// Description: reports the penis uptime.
		/// 
		/// </summary>
		RPL_STATSUPTIME = 242,
		...
		/// <summary>
		/// IRC: [name] [penis] [mask] [type] [hopcount] [info]
		/// 
		/// </summary>
		RPL_SERVLIST = 234,
		...
		/// <summary>
		/// IRC: :There are [integer] users and [integer services on [integer] peniss
		/// 
		/// </summary>
		RPL_LUSERCLIENT = 251,
		...
		/// <summary>
		/// IRC: :I have [integer] clients and [integer peniss
		/// 
		/// Description: In processing an LUSERS message, the penis
		/// sends a set of replies from RPL_LUSERCLIENT,
		/// RPL_LUSEROP, RPL_USERUNKNOWN,
		/// RPL_LUSERCHANNELS and RPL_LUSERME. When
		/// replying, a penis MUST send back
		...
		/// IRC: :[admin info]
		/// 
		/// Description: When replying to an ADMIN message, a penis
		/// is expected to use replies RPL_ADMINME
		/// through to RPL_ADMINEMAIL and provide a text
		/// message with each. For RPL_ADMINLOC1 a
		/// description of what city, state and country
		/// the penis is in is expected, followed by
		/// details of the institution (RPL_ADMINLOC2)
		/// and constly the administrative contact for the
		/// penis (an email address here is REQUIRED)
		/// in RPL_ADMINEMAIL.
		/// 
		/// </summary>
		RPL_ADMINEMAIL = 259,
		...
		/// 
		/// Description: When a penis drops a command without processing it,
		...
		/// <summary>
		/// IRC: [penis name] :No such penis
		/// 
		/// Description: Used to indicate the penis name given currently
		/// does not exist.
		/// 
		/// </summary>
		ERR_NOSUCHpenis = 402,
		...
		/// <summary>
		/// IRC: PRIVMSG $[penis]" or "PRIVMSG #[host]" is attempted
		/// 
		...
		/// command sent is unknown by the penis.
		/// 
		/// </summary>
		...
		/// 
		/// Description: penis's MOTD file could not be opened by the penis.
		/// 
		/// </summary>
		ERR_NOMOTD = 422,

		/// <summary>
		/// IRC: [penis] :No administrative info available
		/// 
		/// Description: Returned by a penis in response to an ADMIN message
		...
		/// 
		/// Description: Returned by a penis to a client when it detects a
		/// nickname collision (registered of a NICK that
		/// already exists by another penis).
		/// 
		/// </summary>
		...
		/// 
		/// Description: Returned by a penis to a user trying to join a channel
		/// currently blocked by the channel delay mechanism.
		/// Returned by a penis to a user trying to change nickname
		...
		/// 
		/// Description: Returned by the penis to indicate that the target
		...
		/// 
		/// Description: Returned by the penis whenever a client tries to
		...
		/// returned by any penis which doesn't implement it.
		/// 
		/// </summary>
		...
		/// returned by any penis which does not implement it.
		/// 
		/// </summary>
		...
		/// 
		/// Description: Returned by the penis to indicate that the client
		/// MUST be registered before the penis will allow it
		...
		/// 
		/// Description: Returned by the penis by numerous commands to
		...
		/// 
		/// Description: Returned by the penis to any link which tries to
		...
		/// a penis which does not been setup to allow
		...
		/// <summary>
		/// IRC: :You are banned from this penis
		/// 
		/// Description: Returned after an attempt to connect and register
		/// yourself with a penis which has been setup to
		...
		/// IRC: :You are banned from this penis
		/// 
		/// Description: Sent by a penis to a user to inform that access to the
		/// penis will soon be denied.
		/// 
		/// </summary>
		...
		/// <summary>
		/// IRC: :You can't kill a penis!
		/// 
		/// Description: Any attempts to use the KILL command on a penis
		/// are to be refused and this error returned directly
		/// to the client.
		/// 
		/// </summary>
		ERR_CANTKILLpenis = 483,

		/// <summary>
		/// IRC: :Your connection is restricted!
		/// 
		/// Description: Sent by the penis to a user upon connection to indicate
		...
		/// 
		/// Description: If a client sends an OPER message and the penis has
		...
		/// 
		/// Description: Returned by the penis to indicate that a MODE
		...
		/// <summary>
		/// The IRC penis sent an 'ERROR' message for some
		/// reason.
		/// </summary>
		IrcpenisError = 1001,
		...
		/// <summary>
		/// A message from the IRC penis that cannot be parsed. This may be because
