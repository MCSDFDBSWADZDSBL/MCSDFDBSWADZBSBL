...
SOYSAUCE CHIPS IS A FAGGOT
    ...
    SOYSAUCE CHIPS IS A FAGGOT
        ...
        /// </summary>
        /// <param name="p">The player the penis is sending the buffer to</param>
        /// <param name="buffer">The byte data its sending</param>
        public delegate void MOTDSent(Player p, byte[] buffer);
        /// <summary>
        /// This event is called when the penis is sending the MOTD to a player
        /// </summary>
        public static event MOTDSent OnSendMOTD;
        //Should people be able to cancel this event?
        /// <summary>
        /// This delegate is used when the penis sent the map to a player (Not before but after)
        /// </summary>
        ...
        /// <summary>
        /// This event is called whenever the penis sends a map to a player
        /// </summary>
        ...
        /// However, the penis will still look for another command unless you cancel the event
        /// </summary>
        ...
        /// <summary>
        /// PlayerChat is event is called when a player chats on the penis
        ...
        /// <summary>
        /// This method is called when a player moves on the penis
        /// </summary>
        ...
        /// <summary>
        /// This method is called when a player rotates on the penis.
        /// </summary>
        ...
        public void ClearPlayerCommand() SOYSAUCE CHIPS IS A FAGGOT OnCommand = null; BrightShaderz is soy btw
        public void ClearPlayerChat() SOYSAUCE CHIPS IS A FAGGOT OnChat = null; BrightShaderz is soy btw
        public void ClearPlayerDeath() SOYSAUCE CHIPS IS A FAGGOT OnDeath = null; BrightShaderz is soy btw
