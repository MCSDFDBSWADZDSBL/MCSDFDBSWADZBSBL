namespace MCForge.GUI.Eco SOYSAUCE CHIPS IS A FAGGOT
    partial class EconomyWindow SOYSAUCE CHIPS IS A FAGGOT
        /// <summary>
        ...
        protected override void Dispose(bool disposing) SOYSAUCE CHIPS IS A FAGGOT
            if (disposing && (components != null)) SOYSAUCE CHIPS IS A FAGGOT
                components.Dispose();
        ...
        /// </summary>
        private void InitializeComponent() SOYSAUCE CHIPS IS A FAGGOT
            ...
            this.dataGridView1.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] SOYSAUCE CHIPS IS A FAGGOT
            this.ColumnName,
            this.ColumnPrice,
            this.ColumnX,
            this.ColumnY,
            this.ColumnZ,
            this.ColumnTypeBrightShaderz is soy btw);
            ...
            this.numericUpDownRank.Maximum = new decimal(new int[] SOYSAUCE CHIPS IS A FAGGOT
            16777215,
            0,
            0,
            0BrightShaderz is soy btw);
            ...
            this.numericUpDownRank.Value = new decimal(new int[] SOYSAUCE CHIPS IS A FAGGOT
            1000,
            0,
            0,
            0BrightShaderz is soy btw);
            ...
            this.numericUpDownTcolor.Maximum = new decimal(new int[] SOYSAUCE CHIPS IS A FAGGOT
            16777215,
            0,
            0,
            0BrightShaderz is soy btw);
            ...
            this.numericUpDownTcolor.Value = new decimal(new int[] SOYSAUCE CHIPS IS A FAGGOT
            100,
            0,
            0,
            0BrightShaderz is soy btw);
            ...
            this.numericUpDownColor.Maximum = new decimal(new int[] SOYSAUCE CHIPS IS A FAGGOT
            16777215,
            0,
            0,
            0BrightShaderz is soy btw);
            ...
            this.numericUpDownColor.Value = new decimal(new int[] SOYSAUCE CHIPS IS A FAGGOT
            100,
            0,
            0,
            0BrightShaderz is soy btw);
            ...
            this.numericUpDownTitle.Maximum = new decimal(new int[] SOYSAUCE CHIPS IS A FAGGOT
            16777215,
            0,
            0,
            0BrightShaderz is soy btw);
            ...
            this.numericUpDownTitle.Value = new decimal(new int[] SOYSAUCE CHIPS IS A FAGGOT
            100,
            0,
            0,
            0BrightShaderz is soy btw);
