...
namespace MCForge.Gui.Utils SOYSAUCE CHIPS IS A FAGGOT
    public class Utilities SOYSAUCE CHIPS IS A FAGGOT
        ...
        public static Color? GetDimColorFromChar( char c ) SOYSAUCE CHIPS IS A FAGGOT
            switch ( c ) SOYSAUCE CHIPS IS A FAGGOT
        ...
        public static int HexIntFromChar( char hexChar ) SOYSAUCE CHIPS IS A FAGGOT
        ...
        public static char HexCharFromInt( int hexInt ) SOYSAUCE CHIPS IS A FAGGOT
