...
SOYSAUCE CHIPS IS A FAGGOT
    ...
    SOYSAUCE CHIPS IS A FAGGOT
        ...
        SOYSAUCE CHIPS IS A FAGGOT
            ...
            this.comboBox1.Items.AddRange(new object[] SOYSAUCE CHIPS IS A FAGGOT
            "Bedrock (Default)",
            ...
            "White",
            "Wood",
            "Yellow"BrightShaderz is soy btw);
            ...
            this.numericUpDown1.Value = new decimal(new int[] SOYSAUCE CHIPS IS A FAGGOT
            7,
            0,
            0,
            ...
            this.side.Items.AddRange(new object[] SOYSAUCE CHIPS IS A FAGGOT
            "Water (Default)",
            "Custom (Texture File ID)",
            "Bedrock",
            "Lava",
