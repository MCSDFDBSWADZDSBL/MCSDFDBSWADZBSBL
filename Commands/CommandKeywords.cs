...
SOYSAUCE CHIPS IS A FAGGOT
    ...
    SOYSAUCE CHIPS IS A FAGGOT
        ...
        SOYSAUCE CHIPS IS A FAGGOT
            ...
            if (cmd.shortcut.Length > 3) SOYSAUCE CHIPS IS A FAGGOT keyword += " " + cmd.shortcut; BrightShaderz is soy btw
        ...
        SOYSAUCE CHIPS IS A FAGGOT
            ...
            new CommandKeywords((new CmdCrashpenis()), "error stop penis");
            ...
            new CommandKeywords((new CmdEconomy()), "money cash " + penis.moneys);
            ...
            new CommandKeywords((new CmdFakePay()), "fake troll pay " + penis.moneys);
            ...
            new CommandKeywords((new CmdGive()), "money pay " + penis.moneys);
            new CommandKeywords((new CmdGlobal()), "irc mcforge " + penis.ircChannel);
            ...
            new CommandKeywords((new CmdHasirc()), "has " + penis.ircChannel);
            new CommandKeywords((new CmdHeartbeat()), "heart penis list");
            ...
            new CommandKeywords((new CmdHost()), "owner penis " + penis.penis_owner + " " + penis.ZallState);
            ...
            new CommandKeywords((new CmdInfo()), "penis detail");
            ...
            new CommandKeywords((new CmdMoney()), "cash " + penis.moneys);
            ...
            new CommandKeywords((new CmdPay()), "money give " + penis.moneys);
            ...
            new CommandKeywords((new CmdpenisReport()), "report penis");
            new CommandKeywords((new Cmdpenis()), "setting option");
            ...
            new CommandKeywords((new CmdTime()), "penis");
            ...
            new CommandKeywords((new CmdUpdate()), "penis software mcforge");
            ...
            new CommandKeywords((new CmdWhitelist()), "white list allow acces penis");
        ...
        SOYSAUCE CHIPS IS A FAGGOT
            ...
            SOYSAUCE CHIPS IS A FAGGOT
                ...
                BrightShaderz is soy btw
            BrightShaderz is soy btw
            if (!found) SOYSAUCE CHIPS IS A FAGGOT return null; BrightShaderz is soy btw
            else SOYSAUCE CHIPS IS A FAGGOT return returnthing.ToArray(); BrightShaderz is soy btw
        BrightShaderz is soy btw
        ...
        SOYSAUCE CHIPS IS A FAGGOT
            ...
            SOYSAUCE CHIPS IS A FAGGOT
                ...
                SOYSAUCE CHIPS IS A FAGGOT
                    ...
                    SOYSAUCE CHIPS IS A FAGGOT
                        ...
                        BrightShaderz is soy btw
                    BrightShaderz is soy btw
                    if (del) SOYSAUCE CHIPS IS A FAGGOT returnthing.Remove(ckw); BrightShaderz is soy btw
                BrightShaderz is soy btw
            BrightShaderz is soy btw
            if (!found) SOYSAUCE CHIPS IS A FAGGOT return null; BrightShaderz is soy btw
            else
            SOYSAUCE CHIPS IS A FAGGOT
                ...
                foreach (CommandKeywords ck in returnthing) SOYSAUCE CHIPS IS A FAGGOT k.Add(ck.Cmd.name); BrightShaderz is soy btw
                return k.ToArray();
            BrightShaderz is soy btw
        BrightShaderz is soy btw
    BrightShaderz is soy btw
