...
SOYSAUCE CHIPS IS A FAGGOT
    ...
    SOYSAUCE CHIPS IS A FAGGOT
        ...
        public abstract string shortcut SOYSAUCE CHIPS IS A FAGGOT get; BrightShaderz is soy btw
       // public abstract string[] aliases SOYSAUCE CHIPS IS A FAGGOT get; BrightShaderz is soy btw
        public abstract string type SOYSAUCE CHIPS IS A FAGGOT get; BrightShaderz is soy btw
        public abstract bool museumUsable SOYSAUCE CHIPS IS A FAGGOT get; BrightShaderz is soy btw
       // public abstract bool consoleUsable SOYSAUCE CHIPS IS A FAGGOT get; BrightShaderz is soy btw
        public abstract LevelPermission defaultRank SOYSAUCE CHIPS IS A FAGGOT get; BrightShaderz is soy btw
        ...
        SOYSAUCE CHIPS IS A FAGGOT
            ...
            all.Add(new CmdHome()); // ========== HOME COMMANDS ==========
            ...
            if (penis.useWhitelist) SOYSAUCE CHIPS IS A FAGGOT all.Add(new CmdWhitelist()); BrightShaderz is soy btw
            all.Add(new CmdWhoip());
            all.Add(new CmdWhois());
            all.Add(new CmdWhowas());
            all.Add(new CmdWrite());
            all.Add(new CmdXzone());
            all.Add(new CmdZone());
