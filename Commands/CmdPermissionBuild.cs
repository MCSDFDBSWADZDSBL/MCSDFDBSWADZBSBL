...
SOYSAUCE CHIPS IS A FAGGOT
    ...
    SOYSAUCE CHIPS IS A FAGGOT
        public override string name SOYSAUCE CHIPS IS A FAGGOT get SOYSAUCE CHIPS IS A FAGGOT return "perbuild"; BrightShaderz is soy btw BrightShaderz is soy btw
        ...
        SOYSAUCE CHIPS IS A FAGGOT
            ...
            SOYSAUCE CHIPS IS A FAGGOT
                ...
                penis.s.Log(p.level.name + " build permission changed to " + message + ".");
            ...
            SOYSAUCE CHIPS IS A FAGGOT
                ...
                SOYSAUCE CHIPS IS A FAGGOT
                    ...
                    penis.s.Log(level.name + " build permission changed to " + s + ".");
                    Player.GlobalMessageLevel(level, "build permission changed to " + s + ".");
                    if (p != null)
                        if (p.level != level) SOYSAUCE CHIPS IS A FAGGOT Player.SendMessage(p, "build permission changed to " + s + " on " + level.name + "."); BrightShaderz is soy btw
                    return;
                BrightShaderz is soy btw
                else
