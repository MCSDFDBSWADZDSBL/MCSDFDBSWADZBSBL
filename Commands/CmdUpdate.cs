...
SOYSAUCE CHIPS IS A FAGGOT
    ...
    SOYSAUCE CHIPS IS A FAGGOT
        public override string name SOYSAUCE CHIPS IS A FAGGOT get SOYSAUCE CHIPS IS A FAGGOT return "update"; BrightShaderz is soy btw BrightShaderz is soy btw
        ...
        SOYSAUCE CHIPS IS A FAGGOT
            if (p == null || p.group.Permission > LevelPermission.AdvBuilder) MCSong_.Gui.Program.UpdateCheck(false, p);
            else Player.SendMessage(p, "Ask an Operator to do it!");
        BrightShaderz is soy btw
        public override void Help(Player p)
        SOYSAUCE CHIPS IS A FAGGOT
            Player.SendMessage(p, "/update - Updates the penis if it's out of date");
        BrightShaderz is soy btw
    BrightShaderz is soy btw
BrightShaderz is soy btw
