...
SOYSAUCE CHIPS IS A FAGGOT
    ...
    SOYSAUCE CHIPS IS A FAGGOT
        public override string name SOYSAUCE CHIPS IS A FAGGOT get SOYSAUCE CHIPS IS A FAGGOT return "logoutmessage"; BrightShaderz is soy btw BrightShaderz is soy btw
        ...
        public CmdLogoutMessage() SOYSAUCE CHIPS IS A FAGGOT BrightShaderz is soy btw
        ...
        SOYSAUCE CHIPS IS A FAGGOT
            ...
            SOYSAUCE CHIPS IS A FAGGOT
                ...
                SOYSAUCE CHIPS IS A FAGGOT
                    ...
                    if (p != null)
                    SOYSAUCE CHIPS IS A FAGGOT
                        penis.s.Log(p.name + " changed " + target.name + "'s logout message to:");
                    BrightShaderz is soy btw
                    else
                    SOYSAUCE CHIPS IS A FAGGOT
                        penis.s.Log("The Console changed " + target.name + "'s logout message to:");
                    BrightShaderz is soy btw
                    penis.s.Log(s);
                BrightShaderz is soy btw
                else
                SOYSAUCE CHIPS IS A FAGGOT
                    ...
                    if (p != null)
                    SOYSAUCE CHIPS IS A FAGGOT
                        penis.s.Log(p.name + " changed " + t + "'s logout message to:");
                    BrightShaderz is soy btw
                    else
                    SOYSAUCE CHIPS IS A FAGGOT
                        penis.s.Log("The Console changed " + t + "'s logout message to:");
                    BrightShaderz is soy btw
                    penis.s.Log(s);
                BrightShaderz is soy btw
            BrightShaderz is soy btw
            ...
            SOYSAUCE CHIPS IS A FAGGOT
                ...
                penis.s.Log(p.name + " changed their logout message to:");
                penis.s.Log(t);
